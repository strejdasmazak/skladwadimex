	...
	*/
	public function fetchAttributeData()
	{
		...
		foreach ($data as $key => $value) {
			...
			// button
			$buttons = '<a href="'.base_url('attributes/addvalue/'.$value['id']).'" class="btn btn-default"><i class="fa fa-plus"></i> Přidat možnost</a> 
			...
			$status = ($value['active'] == 1) ? '<span class="label label-success">Aktivní</span>' : '<span class="label label-warning">Neaktivní</span>';
