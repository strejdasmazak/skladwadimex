...
<div span class="logo">
	<img src="<?php echo base_url('images/logo.png'); ?>" alt="Hlavní logo" style="height: 40px; margin-left: 0 px;">  
  </div>
<!-- /.login-logo -->
    <a href="<?php echo base_url('auth'); ?>"><b>Sklad</b></a>
  </div>
  <div class="login-box-body">
    <p class="login-box-msg">Přihlaš se pro přístup do systému</p>
