    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createBrand', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addBrandModal">Přidat značku</button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Spravovat značky</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Přidat značku</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('brands/create') ?>" method="post" id="createBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Název značky</label>
            <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Zadej název značky" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="active">Stav</label>
            <select class="form-control" id="active" name="active">
              <option value="1">Aktivní</option>
              <option value="2">Neaktviní</option>
            </select>
          </div>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editBrandModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Upravit značku</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('brands/update') ?>" method="post" id="updateBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Název značky</label>
            <input type="text" class="form-control" id="edit_brand_name" name="edit_brand_name" placeholder="Zadej název značky" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="edit_active">Stav</label>
            <select class="form-control" id="edit_active" name="edit_active">
              <option value="1">Aktviní</option>
              <option value="2">Neaktviní</option>
            </select>
          </div>
        </div>
