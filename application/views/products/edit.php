      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Upravit položku</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="product_image">Změnit obrázek</label>
                  <div class="kv-avatar">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Zadej název položky" value="<?php echo $product_data['name']; ?>"  autocomplete="off"/>
                </div>

                <div class="form-group">
                  <label for="sku">ID položky</label>
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="Zadej ID položky" value="<?php echo $product_data['sku']; ?>" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="price">Cena</label>
                  <input type="text" class="form-control" id="price" name="price" placeholder="Zadej cenu" value="<?php echo $product_data['price']; ?>" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="qty">Množství</label>
                  <input type="text" class="form-control" id="qty" name="qty" placeholder="Zadej množství" value="<?php echo $product_data['qty']; ?>" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="availability" name="availability">
                    <option value="1" <?php if($product_data['availability'] == 1) { echo "selected='selected'"; } ?>>Ano</option>
                    <option value="2" <?php if($product_data['availability'] != 1) { echo "selected='selected'"; } ?>>Ne</option>
                  </select>
                </div>
